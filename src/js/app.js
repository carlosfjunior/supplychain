App = {
    ...
    originGrapeGrowerID: "0x0000000000000000000000000000000000000000",
    ...
    readForm: function () {
        ...
        App.originGrapeGrowerID = $("#originGrapeGrowerID").val();
	...
	receiveGrapes: function (event) {
        ...
        App.contracts.SupplyChain.deployed().then(function(instance) {
            return instance.receiveGrapes(App.upc, {from: App.metamaskAccountID});
        }).then(function(result) {
            $("#ftc-item").text(result);
            console.log('receiveGrapes',result);
        }).catch(function(err) {
            console.log(err.message);
        });
    },
    ...
    produceItem: function (event) {
        ...
        App.contracts.SupplyChain.deployed().then(function(instance) {
            return instance.produceItem(App.upc, {from: App.metamaskAccountID});
        }).then(function(result) {
            $("#ftc-item").text(result);
    ...
    stockItem: function (event) {
        ...
        App.contracts.SupplyChain.deployed().then(function(instance) {
            return instance.stockItem(App.upc, {from: App.metamaskAccountID});
        }).then(function(result) {
            $("#ftc-item").text(result);
